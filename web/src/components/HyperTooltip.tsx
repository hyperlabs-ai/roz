  ...
  return (
    <TooltipContent side={side} className="max-w-[17rem] rounded-lg border bg-popover p-3 text-left font-normal text-popover-foreground shadow-lg">
      ...
      <div className="mt-2 overflow-hidden rounded-md border">
        {[['1 línea', '≈ 0.2 pts'], ['100 líneas', '≈ 1.7 pts'], ['10,000 líneas', '≈ 4.8 pts']].map(([lines, pts], i) => (
      ...
      <p className="mt-1.5 font-mono text-[10px] text-muted-foreground/70">log₂(2 + líneas)^1.5 / 10 por commit</p>
    </TooltipContent>
  );
}
